...
namespace Uploader.Application.Images.Repositories
{
    public interface IImageRepository
    {
        ...
        Task<(long count, IReadOnlyList<Image> data)>  GetImagesPaginatedAsync(int pageNumber, int pageSize, bool showDeleted,
        ...
        Task<bool> SoftDeleteImageAsync(Guid id, CancellationToken cancellationToken = default);
